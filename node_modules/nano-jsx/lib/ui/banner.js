...
class Banner extends component_js_1.Component {
    constructor() {
        super(...arguments);
    ...
    top: ${sticky}px;`
        ...
        ${stickyStyles}
        z-index: ${_config_js_1.zIndex.banner}
        `,
            banner: `    
        ...
        const bodyElement = (0, core_js_1.h)('div', { style: styles.body }, body);
        const actionsElement = (0, core_js_1.h)('div', { style: styles.actions }, actionsArray);
        const bannerElement = (0, core_js_1.h)('div', { style: styles.banner }, bodyElement, actionsElement);
        return (0, core_js_1.h)('div', { style: styles.container }, bannerElement);
    }
}
