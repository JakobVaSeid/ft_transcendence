...
export class Img extends Component {
        ...
        const observer = new IntersectionObserver((entries, observer) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    observer.disconnect();
                    this.state.image = h('img', Object.assign({}, rest));
    ...
    render() {
        ...
        if (typeof lazy === 'boolean' && lazy === false) {
            this.state.image = h('img', Object.assign({ src }, rest));
        ...
        if (this.state.isLoaded) {
            ...
            return h('img', Object.assign({ src: placeholder }, rest));
            ...
            return h('div', Object.assign({ style }, others));
        }
    }
}
