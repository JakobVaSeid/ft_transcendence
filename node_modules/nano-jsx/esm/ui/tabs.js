...
export const Tab = (props) => {
    ...
    const a = h('a', Object.assign({}, link), props.children);
...
export class Tabs extends Component {
    ...
    render() {
        ...
        const cssHash = strToHash(scroll.toString() + (children === null || children === void 0 ? void 0 : children.length) + active + ripple.class);
        const styles = `
